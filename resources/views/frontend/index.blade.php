        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont zoomIn wow animated"> 
              <h2>Buat Bisnis Anda Lebih Menarik Dengan <strong>Visual Branding Yang Kekinian</strong> </h2>
              <p>Tidak Punya Waktu Buat Desain ? Jangan Bikin Susah. Terpecaya Dengan Hasil Desain Yang Cepat, Rapih, Kekinian, dan Budget yang Ekonomis.</p>
	...
	<div class="row">
      <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right"><img src="{{asset('frontend/img/ab2.jpg')}}" class="img-circle delay-03s animated wow zoomIn" alt=""></div>
      	<div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
            ...
            <p>Dandy Studio adalah Sebuah Jasa Desain Grafis Online, Jasa ini dibuat agar dapat membantu orang orang yang membutuhkan bantuan seputar desain grafis.</p> <br/>
  ...
  <div class="container">
    ...
    <div class="service_wrapper">
      <div class="row">
       ...
       <!--     <div class="service_icon delay-03s animated wow  zoomIn"> <span><i class="fas fa-palette"></i></span> </div> -->
            <h3 class="animated fadeInUp wow">Motion Grafis</h3>
            <p class="animated fadeInDown wow">Secara sederhana, motion grafis adalah percabangan dari seni desain grafis yang merupakan penggabungan dari ilustrasi, tipografi, fotografi dan videografi dengan menggunakan teknik animasi bergerak.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft">			
          <div class="service_block">
       <!--      <div class="service_icon icon2  delay-03s animated wow zoomIn"> <span><i class="fa fa-apple"></i></span> </div> -->
            <h3 class="animated fadeInUp wow">User Interface</h3>
            <p class="animated fadeInDown wow">Dalam konteks desain grafis, desain UI berfokus pada pengalaman visual pengguna dan desain elemen grafis di layar seperti tombol, menu, mikro – interaksi, dan banyak lagi. Ini adalah pekerjaan desainer UI untuk menyeimbangkan daya tarik estetika dengan fungsi teknis.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft">
          <div class="service_block">
      <!--       <div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-html5"></i></span> </div> -->
            <h3 class="animated fadeInUp wow">Identitas Visual</h3>
            <p class="animated fadeInDown wow">Identitas visual sering digunakan untuk membedakan suatu produk atau jasa yang sama dengan milik pesaing sehingga costumer akan dengan mudah mengidentifikasi suatu merek hanya dengan melihat sebagian dari tampilan visualnya.</p>
          </div>
        </div>
      </div>
     ...
     <!--        <div class="service_icon delay-03s animated wow  zoomIn"> <span><i class="fa fa-dropbox"></i></span> </div> -->
            <h3 class="animated fadeInUp wow">Publikasi</h3>
            <p class="animated fadeInDown wow">Publikasi adalah bagian dalam industri desain grafis yang berkomunikasi dengan masyarakat melalui distribusi publik. Mereka sering disebut sebagai industri media cetak.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft mrgTop">
          <div class="service_block">
     <!--        <div class="service_icon icon2  delay-03s animated wow zoomIn"> <span><i class="fa fa-slack"></i></span> </div> -->
            <h3 class="animated fadeInUp wow">Desain Kemasan</h3>
            <p class="animated fadeInDown wow">desain kemasan dapat berkomunikasi langsung dengan konsumen, yang menjadikannya alat pemasaran yang sangat berharga. Setiap kotak, botol dan tas, setiap kaleng, wadah, atau tabung adalah kesempatan menceritakan kisah tentang suatu merek.</p>
          </div>
        </div>
        <div class="col-lg-4 borderLeft mrgTop">
          <div class="service_block">
     <!--        <div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-users"></i></span> </div> -->
            <h3 class="animated fadeInUp wow">Seni dan Ilustrasi</h3>
            <p class="animated fadeInDown wow">Seni grafis dan ilustrasi sering terlihat sama dengan desain grafis, namun masing-masing sangat berbeda. Desainer menciptakan komposisi untuk berkomunikasi dan memecahkan masalah, seniman grafis dan ilustrator membuat karya seni asli.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="team_section clearfix">
      <div class="team_area">
        ...
        <h3 class="wow fadeInDown delay-03s">Dandy Helnasya</h3>
        <span class="wow fadeInDown delay-03s">Chief Executive Officer of Dandy Studio</span>
      ...
      <div class="team_area">
        ...
        <h3 class="wow fadeInDown delay-06s">Ajie Sadewa</h3>
        <span class="wow fadeInDown delay-06s">UI / UX Design</span>
      ...
      <div class="team_area">
        ...
        <h3 class="wow fadeInDown delay-09s">Aulia Rahmita</h3>
        <span class="wow fadeInDown delay-09s">Profesional Ilustrator</span>
...
<footer class="footer_wrapper" id="contact">
      ...
      <div class="row">
        <div class="col-lg-4 wow fadeInLeft">	
		 <div class="contact_info">
                            <div class="detail">
                                <h4>Infoway</h4>
                                <p>D 42, Batola Resident, Alalak, Indonesia</p>
                            </div>
                            <div class="detail">
                                <h4>Call Us</h4>
                                <p>+62 8 2255 94 2255</p>
                            </div>
                            <div class="detail">
                                <h4>Email us</h4>
                                <p>dandy.helnasya9@gmail.com</p>
                            </div> 
                        </div>
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © 2020, Dandy Studio</a>. </span> </div>
  </div>
</footer>
